-- =====================================================
-- Sakila Database DDL Export
-- Schema: sakila
-- Generated: 2025-09-20T15:14:55.004Z
-- MySQL Version: 9.4.0
-- Total Objects: 23
-- =====================================================
...
-- View 4: nicer_but_slower_film_list
...
-- address:
--   city_id -> city.city_id (CASCADE/RESTRICT)

-- city:
--   country_id -> country.country_id (CASCADE/RESTRICT)

-- customer:
--   address_id -> address.address_id (CASCADE/RESTRICT)
--   store_id -> store.store_id (CASCADE/RESTRICT)

-- film:
--   language_id -> language.language_id (CASCADE/RESTRICT)
--   original_language_id -> language.language_id (CASCADE/RESTRICT)

-- film_actor:
--   actor_id -> actor.actor_id (CASCADE/RESTRICT)
--   film_id -> film.film_id (CASCADE/RESTRICT)

-- film_category:
--   category_id -> category.category_id (CASCADE/RESTRICT)
--   film_id -> film.film_id (CASCADE/RESTRICT)
...
-- payment:
--   customer_id -> customer.customer_id (CASCADE/RESTRICT)
--   rental_id -> rental.rental_id (CASCADE/SET NULL)
--   staff_id -> staff.staff_id (CASCADE/RESTRICT)

-- rental:
--   customer_id -> customer.customer_id (CASCADE/RESTRICT)
--   inventory_id -> inventory.inventory_id (CASCADE/RESTRICT)
--   staff_id -> staff.staff_id (CASCADE/RESTRICT)
...
-- store:
--   address_id -> address.address_id (CASCADE/RESTRICT)
--   manager_staff_id -> staff.staff_id (CASCADE/RESTRICT)
